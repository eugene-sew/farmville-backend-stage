...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,testserver,farmville.ballotbase.online,ballotbase.online', cast=lambda v: [s.strip() for s in v.split(',')])
