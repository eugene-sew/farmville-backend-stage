...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,testserver,farmville.ballotbase.online,ballotbase.online,farmvapi.onehiveafrica.com,onehiveafrica.com', cast=lambda v: [s.strip() for s in v.split(',')])
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'FarmVille API',
    'DESCRIPTION': 'AI Crop Disease Detection & Management System',
    'VERSION': '1.0.0',
